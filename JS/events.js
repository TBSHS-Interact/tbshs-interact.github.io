const events = {
    "2020 - 2021": {
        ...
        "Food Bank Collection": {
            ...
            text: "To mark the end of the first half term of our 2020-2021 school year, students were encouraged to make donation to the <a>Bishop's Stortford Food Bank</a>. Due to the effects of COVID-19 on the world and our nation, manny people require services such as the food bank more than ever. The student body came together on <a>Friday, 23 October 2020</a> to donate over three shopping trolleys worth of items."
        }
    },
    "2019 - 2020": {
        "International Women's Day": {
            image: "logo_iwd.png",
            text: "This day is very important at TBSHS. Although we are a single-sex male school from years 7-11, our Sixth Form is mixed education, and is the heart of the school. <a>IWD</a> was on <a>Sunday, 8 March 2020</a>, and despite not being in school on this day, we recognised it, within school, for a whole week afterwards."
        },
        "Shrove Tuesday": {
            image: "shrove-tuesday.png",
            text: "Everybody loves pancake day at TBSHS. For the past few years, Interact have sold pancakes to raise money for some local charities. This year on <a>Tuesday, 25 February 2020</a> we raised £392 for <a>St. Michael's Church</a>."
        },
        ...
        "Tesco Bag Packing with Rotary": {
            ...
            text: "For thirteen hours across <a>Saturday, 14 December 2019</a> and <a> Sunday, 15 December 2019</a>, a large number of students took part in bag packing at Tesco in Bishop's Stortford to help the <a>Rotary Club</a> raise money towards their <a>Christmas Food Parcels</a> to help less fortunate families at this time.<br>This event is one we do most years in Waitrose and Tesco, and always has an outstanding turnout of students."
        },
        "Showcase 2019": {
            image: "logo_showcase-2019.png",
            text: "Our annual talent show took place on <a>Friday, 13 December 2019, at 19: 00</a>, in the school hall. All money raised went to the <a>Food Bank</a>, the <a>Night Shelter</a> and <a>St. Michael's Church</a>.",
        },
        "TBSHS Poppy Appeal": {
            image: "logo_poppy-appeal.png",
        ...
        "Wear It Blue for Mental Health": {
            image: "logo_mind.png",
            text: "This themed non-uniform day in October, was an opportunity for people to wear one item of blue clothing with their school uniform. Money raised went towards raising awareness for the mental health charity <a>Mind</a>. This is an issue which needs to be talked about. We all have mental health, we should all feel comfortable talking about it."
        }
    }
};
